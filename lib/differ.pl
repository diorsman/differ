...
getopts('h:f:t:rl:sL:c:C:e:nNo:p:') or Usage();
...
<tr><th align="center" bgcolor="#000000" colspan="2"><font color="#add8e6">BASE </font><font color="#e0ffff">TARGET </font></th></tr>
    ...
    while (<DIFF>) {
        ...
        if ( $difftxt =~ /^diff / ) {
            ...
            if ( $difftxt =~ /^--- / ) {
                ...
                print qq(<font color="#add8e6">$CaptionText</font>);
                print qq(</th>\n);

                $CaptionText = $RightCaptionText;
                $CaptionText =~ s/#NAME#/$rightfile/gi;
                print qq(<th width="50%" valign="top">);
                print qq(<font color="#e0ffff">$CaptionText</font>);
                print qq(</th>\n</tr>);
                ...
                print qq(<th width="50%" valign="top">);
                if ( $difftxt =~ /$File1/ ) {
                    print qq(<font color="#ff0000">$difftxt</font>);
                }
                else {
                    print qq(<font color="#ffffff">        </font>);
                }
                print qq(</th>\n);
                print qq(<th width="50%" valign="top">);
                if ( $difftxt =~ /$File2/ ) {
            ...
            if ($opt_N) {
                ...
                print "<tr><th width=\"50%\" bgcolor=\"$diffcolorLineNum\"><b>Start $LeftText</b></th>", "<th width=\"50%\" bgcolor=\"$diffcolorLineNum\">Start $RightText</th></tr>\n";
            }
        ...
        elsif ( $difftxt =~ / differ$/ ) {
            print qq(<table border="0" cellspacing="0" cellpadding="0" width="100%">\n);
            print qq(<tr bgcolor="#000000">\n);
            print qq(<th width="100%" valign="top">);
            print qq(<font color="#9f5f9f">$difftxt</font>);
            print qq(</th>\n</tr>);
            #my @fields = split(' ', $difftxt);
            #my $base = $fields[-4];
            #my $target = $fields[-2];
            #print qq(<table border="0" cellspacing="0" cellpadding="0" width="100%">\n);
            #print qq(<tr bgcolor="#000000">\n);
            #print qq(<th width="50%" valign="top">);
            #print qq(<font color="#9f5f9f">Binary files: $base</font>);
            #print qq(</th>\n);
            #print qq(<th width="50%" valign="top">);
            #print qq(<font color="#9f5f9f">Binary files: $target</font>);
            #print qq(</th>\n</tr>);
        }
    }
    flush_diff_rows \@leftCol, \@rightCol, $leftRow, $rightRow;
